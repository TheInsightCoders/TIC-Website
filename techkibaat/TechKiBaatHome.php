    ...
    <section class="portfolio-details">
      <div class="container">
        ...
        <div class="portfolio-details-container">
          <div>
            <img src="../assets/img/techkibaat/techkibaat.png" style="margin-left:5px; height:auto; width:100%" alt="">
          </div>
        </div>
    ...
    <section class="counts section-bg">
      <div class="container">
		...
		<div class="section-title">			
              <h1 style="color:#FF5733;"><b>Tech Ki Baat</b></h1>
          <br>
        </div>  
		
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <a href="https://youtu.be/7iuS4onZ7F0" target="_blank">
			<div class="count-box">
              <img src="../assets/img/techkibaat/01.jpg" width="200px" height="100px" alt="">
            </div>
			</a>
          </div>

          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
              <a href="https://youtu.be/3Nj1hMZl75s" target="_blank">
            <div class="count-box">
             <img src="../assets/img/techkibaat/02.jpg" width="200px" height="100px" alt="">
            </div>
              </a>
          </div>

          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <a href="https://youtu.be/rkd3jep30gg" target="_blank">
              <div class="count-box">
                <img src="../assets/img/techkibaat/03.jpg" width="200px" height="100px" alt="">
            </div>
          </a>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <a href="https://youtu.be/zI16KRYT85c" target="_blank">
              <div class="count-box">
                <img src="../assets/img/techkibaat/04.jpg" width="200px" height="100px" alt="">
            </div>
          </a>
          </div>
        </div>
