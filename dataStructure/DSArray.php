...
<head>
  ...
  <title>Data Strucutres - Array</title>
				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
                            <h1 style="color:#FF5733;"><b>Data Strucutres - Arrays</b></h1>
							  <pre style="text-align: justify; text-justify: inter-word; font-family:'Calibri'; font-size:20px; color:black; line-height:'1.4';">
<a href="#Array1">1. Array and Types</a>          <a href="#Array2">2. Representation of Array</a>         <a href="#Array3">3. Travesing and Intilization</a>
							  </pre>
						</div>
					  </div>
					</div>
    ...
    <section class="counts section-bg">
      <div class="container">
        ...
        <div class="row" id="Array1">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Array and Its Types</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/1G3pQUgTBw4"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="Array2">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Representation of Array</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/sXbmtlgFZCg"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="Array3">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Traversing and Initialization</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/oV_XtE-NgDc"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
