				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
                            <h1 style="color:#FF5733;"><b>Data Structure - Linked List</b></h1>
							  <pre style="text-align: justify; text-justify: inter-word; font-family:'Calibri'; font-size:20px; color:black; line-height:'1.4';">
<a href="#LLIntro">1. Introduction</a>          <a href="#LLRep">2. Representation and Types</a>          <a href="#LLSearch">3. Searching</a>          <a href="#LLInsetion">4. Insertion in Beginning</a>          <a href="#LLDeletion">5. Deleting a Node</a>
<a href="#LLCircular">6. Circular Linked List</a>
							  </pre>
						</div>
					  </div>
					</div>
    ...
    <section class="counts section-bg">
      <div class="container">
        ...
        <div class="row" id="LLIntro">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Linked List Introduction</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/D5JRBvzWuaw"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="LLRep">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Linked List Representation and Types</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/TVRUdDAYtyw"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="LLSearch">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Searching in Linked List </b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/8oRnf9BQ_SE"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="LLInsetion">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Insertion in Linked List </b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/FjPK3kDF9QQ"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="LLDeletion">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Deletion in Linked List </b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/BCG_gr6hzZc"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="LLCircular">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Circular Linked List </b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/WifrvLQtUj0"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
