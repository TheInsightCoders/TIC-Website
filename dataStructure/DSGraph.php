...
<head>
  ...
  <title>Data Strucutre Graphs</title>
				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
                            <h1 style="color:#FF5733;"><b>Data Strucutre - Graphs</b></h1>
							  <pre style="text-align: justify; text-justify: inter-word; font-family:'Calibri'; font-size:20px; color:black; line-height:'1.4';">
<a href="#GIntro">1. Introduction</a>          <a href="#Kruskal">2. Kruskal's Algorithm</a>          <a href="#Prims">3. Prim's Algorithm</a>          <a href="#Topological">4. Topological Sort</a>          <a href="#Dijkstra">5. Dijkstra's Algorithm</a>
<a href="#Floyad">6. Floyd Warshall Algorithm</a>
							  </pre>
						</div>
					  </div>
					</div>
