				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
                            <h1 style="color:#FF5733;"><b>Data Structure Stack</b></h1>
							  <pre style="text-align: justify; text-justify: inter-word; font-family:'Calibri'; font-size:20px; color:black; line-height:'1.4';">
  <a href="#SIntro">1. Introduction</a>          <a href="#DynamicImp">2. Dynamic Implementation</a>          <a href="#PushPop">3. Push & Pop Operation</a>
							  </pre>
						</div>
					  </div>
					</div>
    ...
    <section class="counts section-bg">
      <div class="container">
            ...
            <div class="count-box">
                  ...
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/NG0fMfNu2lc"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="DynamicImp">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Dynamic Implementation</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/_h3nF547JL8"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
        ...
        <div class="row" id="PushPop">
          <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
            <div class="count-box">
                  <div class="section-title">
                  <h2 style="color: #393736;"><b>Push and Pop Operations</b></h2>
            </div>
                  <div class="row no-gutters">
                    <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                      <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/h5oy2x9ynRM"  allowfullscreen>
                      </iframe>
                    </div>
                  </div>
            </div>
