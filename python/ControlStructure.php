...
<head>
  ...
  <title>Python - Control Structure</title>
				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							  <h2>Python - Control Structure</h2>
							  <div class="row no-gutters">
                                <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                                  <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/hOmfsKw8-A8"  allowfullscreen>
                                  </iframe>
                                </div>
                              </div>
						</div>
