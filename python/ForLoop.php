...
<div class="main">
  ...
  <div class="sidenavhead">Decision</div>
    ...
    <a href="#">Ladder-If</a>
    <a href="#">Nested-If</a>
    <a href="#">Switch Statement</a>
  <div class="sidenavhead">Variables</div>
    <a href="#">Local Variable</a>
...
<button class="openbtn" onclick="openNav()">☰ Content</button><br><br><br>
        ...
        <div class="portfolio-details-container">
          ...
          <div>
            <img src="../assets/img/python/python.png" style="margin-left:5px; height:auto; width:100%" alt="">
          </div>
				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							  <h2>Python - For Loop Part 1</h2>
							  <div class="row no-gutters">
                                <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                                  <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/iIKWUGu3j6M"  allowfullscreen>
                                  </iframe>
                                </div>
                              </div>
                              <h2>Python - For Loop Part 2</h2>
							  <div class="row no-gutters">
                                <div class="col-lg-6 video-box" style="display: block; margin-left: auto; margin-right: auto;">
                                  <iframe style="margin-top:8px; width:100%; height:400px;" src="https://www.youtube.com/embed/bJ38ukpYPBE"  allowfullscreen>
                                  </iframe>
                                </div>
                              </div>
						</div>
