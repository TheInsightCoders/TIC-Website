...
<head>
  ...
  <title>Password Generations - Statement 6</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>Password Generations</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/JFdajhUpPWE" target="_blank">Password Generations</a></li>
            </ul>
          </div>
        </div>
					...
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box1">
							<h2 style="color:  #FF5733;  font-size: 30px;">Infytq Problem 6 - <strong>Password Generations</strong></h2>
						</div>
					  </div>
					</div>
				</div>
					  ...
					  <div class="col-lg-6 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<p style="font-family:'Calibri'; font-size:18px; color:black; line-height:'1.4';">
								...
								<br><br>
                                Find the maximum digit from code which is less than or equal to(<=) the length of name and put the place char in the final string if there is no any digit found which satisfies the given condition then simply put ‘X’.
                                <br><br>
								<b>Example 1:</b>
								<br>
                                <b>Input:</b>Anchal:23581,Aman:57568,Sonakshi:34848,Ria:14585
                                <br>
                                <b>Output:</b>aXiR
                                <br><br>
                                <b>Example 2:</b>
								<br>
                                <b>Input:</b>Sonakshi:34848,Naman:4739,Prachi:2949,Ekta:9889
                                <br>
                                <b>Output:</b>iacX
								<br><br>
							</p>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/JFdajhUpPWE"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
