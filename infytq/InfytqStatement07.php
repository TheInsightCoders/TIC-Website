...
<head>
  ...
  <title>Character Shifting - Statement 7</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>Character Shifting</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/X_xKek0ww4M" target="_blank">Character Shifting</a></li>
            </ul>
          </div>
        </div>
					...
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box1">
							<h2 style="color:  #FF5733;  font-size: 30px;">Infytq Problem 7 - <strong>Character Shifting</strong></h2>
						</div>
					  </div>
					</div>
				</div>
					  ...
					  <div class="col-lg-6 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<p style="font-family:'Calibri'; font-size:18px; color:black; line-height:'1.4';">
                                ...
                                <b>Example:</b>
								<br>
                                <b>Input:</b>abcd:1234,bcdgfhf:127836,sdjks:1245
                                <br>
                                <b>Output:</b>cdab cdgfhfb kssdj
                                <br><br>
							</p>
						</div>
					  </div>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/X_xKek0ww4M"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
