...
<head>
  ...
  <title>String Reverse - Statement 2</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>String Reverse</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/tIYlzblfcJ8" target="_blank">String Reverse</a></li>
            </ul>
          </div>
        </div>
					...
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box1">
							<h2 style="color:  #FF5733;  font-size: 30px;">Infytq Problem 2 - <strong>String Reverse</strong></h2>
						</div>
					  </div>
					</div>
				</div>
					  ...
					  <div class="col-lg-6 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<p style="font-family:'Calibri'; font-size:18px; color:black; line-height:'1.4';">
								...
								<br>
								You are given a string. The task is to reverse the string. But it is not simple as it looks. You have to remove the duplicate values before reversing the string.
								<br><br>
								<b>Example 1:</b> infosys<br>
                                ysofni
								<br>
                                <b>Example 2:</b> google<br>
                                elog
								<br><br>
							</p>
						</div>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/tIYlzblfcJ8"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
