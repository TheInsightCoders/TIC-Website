...
<head>
  ...
  <title>Minimum Distinct Elements - Statement 9</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>Minimum Distinct Elements</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/-4PKGl7mvCc" target="_blank">Minimum Distinct Elements</a></li>
            </ul>
          </div>
        </div>
					...
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box1">
							<h2 style="color:  #FF5733;  font-size: 30px;">Infytq Problem 9 - <strong>Minimum Distinct Elements</strong></h2>
						</div>
					  </div>
					</div>
				</div>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/-4PKGl7mvCc"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
