...
<head>
  ...
  <title>Concatenate List - Statement 1</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>Concatenate List</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/f046i7DUaCc" target="_blank">Concatenate List</a></li>
            </ul>
          </div>
        </div>
					...
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box1">
							<h2 style="color:  #FF5733;  font-size: 30px;">Infytq Problem 1 - <strong>Concatenate List</strong></h2>
						</div>
					  </div>
					</div>
				</div>
					  ...
					  <div class="col-lg-6 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<p style="font-family:'Calibri'; font-size:18px; color:black; line-height:'1.4';">
								<strong style=" font-family:'Calibri'; font-size:20px; color:black;">Input</strong>
								<br>
								A string of comma separated numbers are given such that the numbers 4 and 78 are already present in the list. Assume that 7 always comes after 4 in the given string.
								<br><br>
								<b>Case 1:</b> num1 = add all numbers which do not lie between 4 and 7 in the input(excluding 4 and  7).
								<br>
                                <b>Case 2:</b> num2 = numbers formed by concatenating all numbers from 4 to 7(including 4 and  7).
								<br><br>

								<strong style=" font-family:'Calibri'; font-size:20px; color:black;">Output</strong>
								<br>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/f046i7DUaCc"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
