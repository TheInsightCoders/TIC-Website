...
<head>
  ...
  <title>Prime Fibonacci - Statement 4</title>
      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="portfolio-info">
            <h3 style="font-size:30px; color: #fe350d;"><strong><center>Prime Fibonacci</center></strong></h3>
            <ul>
              ...
              <li style="font-size:18px;"><strong>Youtube</strong>: <a href="https://youtu.be/wy7C_fPJaXE" target="_blank">Prime Fibonacci</a></li>
            </ul>
          </div>
				...
				<div class="container">
					<div class="row">
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<h2 style="color:  #FF5733;">Codevita Problem 4 - <strong>Prime Fibonacci</strong></h2>
							  ...
							  <div class="container">
								<div class="row no-gutters">
								  <div class="col-lg-5 video-box">
									<iframe style="margin-top:8px; width:100%; height:300px;" src="https://www.youtube.com/embed/wy7C_fPJaXE"  allowfullscreen>
									</iframe>
								  </div>
								</div>
							  </div>
					  ...
					  <div class="col-lg-12 col-md-3 text-left" data-aos="fade-up">
						<div class="count-box">
							<p style="font-family:'Calibri'; font-size:18px; color:black; line-height:'1.4';">
                                ...
                                <br>
                                Combination of all the primes = [3137, 3141, 3143, 3147, 3153, 3159, 3161, 3167, 3731, 3741, 3743, 3747, 3753, 3759, 3761, 3767, 4131, 4137, 4143, 4147, 4153, 4159, 4161, 4167, 4331, 4337, 4341, 4347, 4353, 4359, 4361, 4367, 4731,4737, 4743, 4753, 4759, 4761, 4767, 5331, 5337,5341, 5347, 5359, 5361, 5367, 5931, 5937, 5941, 5943, 5947, 5953, 5961, 5967, 6131, 6137, 6141, 6143, 6153, 6159, 6167, 6731, 6737, 6741, 6743, 6747, 6753, 6759, 6761]
                                <br>
                                2nd prime list = [3137, 5953, 5347, 6761, 3761, 4337, 6737, 6131, 3767, 4759, 4153, 3167, 4159, 6143]
                                <br>
                                smallest (a) = 3137   largest (b) = 6761
                                <br>
