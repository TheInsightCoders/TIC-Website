      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./Codevita/CodevitaIntroduction.php">Codevita</a></li>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./Infytq/InfytqIntroduction.php">Infytq</a></li>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./nqt/NqtIntroduction.php">NQT</a></li>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./patterns/PatternIntroduction.php">Patterns</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./python/PythonIntroduction.php">Python</a></li>
              <li><i class="bx bx-chevron-right" style="color:orange;"></i> <a href="./java/JavaIntroduction.php">Java</a></li>
